...
const changeDataPurgeSettingService = async (groupCode, dataPurgeEnabled) => {
  const updatedGroup = await Group.findOneAndUpdate(
    { [COMMON_FIELDS.GROUP_CODE]: groupCode },
    { [GROUP_FIELDS.DATA_PURGE_ENABLED]: dataPurgeEnabled },
...
export default changeDataPurgeSettingService;
